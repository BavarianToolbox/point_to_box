...
__all__ = ['get_norm_stats', 'draw_rect', 'convert_cords', 'resize', 'noise', 'get_prompt_points']
...
# Cell
def get_prompt_points(anns, n):
    """Get list of object prompt points by sampeling random points in the object polygons
    ...
    **Params**
    ...
    for anno in anns:
        ...
        while len(ppoint) < n:
            ...
            # rand point form center of poly
